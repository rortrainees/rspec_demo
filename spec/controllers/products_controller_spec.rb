...
RSpec.describe ProductsController, type: :controller do
  ...
  let(:valid_attributes) {
    {name: "amit",category: "mobile",price: "10000"}
  }

  let(:invalid_attributes) {
    {name: "amit",category: "mobile",price: nil }
  }
  ...
  describe "GET #index" do
    it "assigns all products as @products" do
      product = Product.create!(name: 'mobile',category: 'man' ,price: '12355')
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Product" do
        expect {
          post :create, {:product => {name: 'mobile',category: 'man' ,price: '12355'} }, valid_session
